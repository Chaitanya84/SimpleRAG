...
PAGES_CSV = "human_nutrition_text_pages.csv"
CHUNKS_EMBEDDINGS_CSV = "text_chunks_and_embeddings_df_NEW.csv"
EMBEDDINGS_TENSOR_FILE = "text_chunks_and_embeddings_embeddings_NEW.pt"  # new binary file with raw embeddings
