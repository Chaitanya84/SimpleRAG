...
CHUNKS_CSV = "MahaBharata_df.csv"
EMBEDDINGS_TENSOR_PATH = "MahaBharata.pt"  # binary tensor produced earlier
...
\nExample 1:
Query: What is the central conflict of the Mahabharata?
Answer: The central conflict of the Mahabharata is the dynastic struggle between the Pandavas and the Kauravas over the throne of Hastinapura. This rivalry escalates from palace intrigue and contested succession into a full-scale war at Kurukshetra, driven by claims of honor, duty (dharma), and vengeance. The epic explores how personal ambitions, moral dilemmas, and the responsibilities of kingship culminate in catastrophic violence, shaping the fate of kingdoms and individuals alike.
\nExample 2:
Query: What is the Bhagavad Gita and its main teaching?
Answer: The Bhagavad Gita is a philosophical and spiritual dialogue between Prince Arjuna and his charioteer Krishna that occurs on the eve of the Kurukshetra war. Its main teaching emphasizes performing one’s duty (dharma) without attachment to the results, combining selfless action (karma), devotion (bhakti), and right knowledge (jnana) as paths to liberation. Krishna counsels Arjuna on righteousness, the nature of the self, and disciplined action, offering practical guidance for moral decision-making amid conflict.
/nExample 3:
Query: Who killed Karna and what were the circumstances?
Answer: Karna was killed by Arjuna during the Kurukshetra war, aided by Krishna’s strategic counsel. The killing occurred after Karna’s chariot wheel became stuck in the earth and he was momentarily disarmed; despite rules of combat and pleas, Arjuna—with Krishna’s urging—took the opportunity to strike Karna down. The episode highlights themes of fate, honor, and controversial wartime ethics within the epic.
